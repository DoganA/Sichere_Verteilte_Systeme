...
cleartext = open(currentDirectory+"\\asd\\sample.txt", 'r+');
encryptedtext = open(currentDirectory+"\\asd\\sample.enc_txt", 'r+');
...
def main():
    ...
    fo = open(currentDirectory+"\\asd\\sample.txt_enc")
    text = fo.read();
    #globalCounter=0
